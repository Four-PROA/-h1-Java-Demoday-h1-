        ...
        <div class="registration__dimension-container">
          <div class="row">
            ...
            <div class="col-6">
              ...
              <h3>Olá, seja bem-vindo ao Casterizzi! </h3>
              <p>Para fazer o seu cadastro vou precisar de algumas informações </p>
          ...
          <h6>Você já tem uma conta? <a href="./cadastro2.html"> <span> Faça login!</span> </a></h6>
        </div>
